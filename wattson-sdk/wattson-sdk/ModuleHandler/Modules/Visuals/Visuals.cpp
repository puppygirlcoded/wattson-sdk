...
void Visuals::OnUpdate()
{
	...
	for (Player m_Player : m_arrPlayers)
	{
		...
		if (g_Vars->Visuals.Health)
		{
			...
			g_Render->AddText(m_sHealth, { m_vecBoundingBox.x + m_vecBoundingBox.z / 2.f, m_vecBoundingBox.y + 2.f }, Wattson::Color(255, 125, 125).Lerp(Wattson::Color(125, 255, 125), m_flHealth), true);
		}
